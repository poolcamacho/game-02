...
describe('Gilded Rose', function () {
    ...
    describe('#tick', function () {
        ...
        context ('normal Items', function () {
            ...
            it ('updater normal items before sell date', function () {
            ...
            it ('updater normal items on the sell date', function () {
            ...
            it ('updater normal items after the sell date', function () {
            ...
            it ('updater normal items with a quality of 0', function () {
        ...
        context('Brie Items', function () {
            ...
            it ('updater Brie items before the sell date', function () {
            ...
            it ('updater Brie items before the sell date with maximum quality', function () {
            ...
            it ('updater Brie items on the sell date', function () {
            ...
            it ('updater Brie items on the sell date, near maximum quality', function () {
            ...
            it ('updater Brie items on the sell date with maximum quality', function () {
            ...
            it ('updater Brie items after the sell date', function () {
            ...
            it ('updater Briem items after the sell date with maximum quality', function () {
        ...
        context('Sulfuras Items', function () {
            ...
            it ('updater Sulfuras items before the sell date', function () {
            ...
            it ('updater Sulfuras items on the sell date', function () {
                const gildedRose = new GildedRose([ new Item('Sulfuras, Hand of Ragnaros', 10, 5) ]);
            ...
            it ('updater Sulfuras items after the sell date', function () {
        ...
        context('Backstage Passes', function () {
            /*
                ...
                0 after the concert
             */
            it ('updater Backstage pass items long before the sell date', function () {
            ...
            it ('updater Backstage pass items close to the sell date', function () {
            ...
            it ('updater Backstage pass items close to the sell data, at max quality', function () {
            ...
            it ('updater Backstage pass items very close to the sell date', function () {
            ...
            it ('updater Backstage pass items very close to the sell date, at max quality', function () {
            ...
            it ('updater Backstage pass items with one day left to sell', function () {
            ...
            it ('updater Backstage pass items with one day left to sell, at max quality', function () {
            ...
            it ('updater Backstage pass items on the sell date', function () {
            ...
            it ('updater Backstage pass items after the sell date', function () {
        ...
        context ("Conjured Items", function () {
            ...
            it ('updater Conjured items before the sell date', function () {
            ...
            it ('updater Conjured items at zero quality', function () {
            ...
            it ('updater Conjured items on the sell date', function () {
            ...
            it ('updater Conjured items on the sell date at 0 quality', function () {
            ...
            it ('updater Conjured items after the sell date', function () {
                const gildedRose = new GildedRose([ new Item('Conjured Mana Cake', 10, -10) ]);
            ...
            it ('updater Conjured items after the sell date at zero quality', function () {
                const gildedRose = new GildedRose([ new Item('Conjured Mana Cake', 0, -10) ]);
